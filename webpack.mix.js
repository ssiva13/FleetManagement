...
//copying app javascript assets
var app_js_assets = {
    js: [
        folder.src + "js/advanced-form.js",
        folder.src + "js/ajax-modal-popup.js",
        folder.src + "js/custom.js"
    ]
};
...
var out = folder.dist_assets + "js/";
    ...
    lodash(app_js_assets).forEach(function (assets, type) {
        for (let i = 0; i < assets.length; ++i) {
            mix.js(assets[i], out);
        };
    });
