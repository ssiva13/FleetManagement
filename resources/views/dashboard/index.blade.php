...
@section('content')
    ...
    <div class="row">
        ...
        @component('common-components.breadcrumb')
            ...
            @slot('li3') Home  @endslot
            @slot('link1') {{ route('home') }}  @endslot
            @slot('link2') {{ route('home') }}  @endslot
        @endcomponent
...
{{--                <a class="dropdown-item" href="{{ route('cars.index') }}">All Cars/Vehicles</a>--}}
    ...
    <div class="row">
        ...
        @component('common-components.dashboard-widget')
            @slot('icons') mdi mdi-road-variant float-right  @endslot
            @slot('class') bg-secondary  @endslot
            @slot('title') Trips  @endslot
            @slot('price') 158  @endslot
        ...
        @component('common-components.dashboard-widget')
            ...
            @slot('class') bg-info  @endslot
            @slot('title') Revenue  @endslot
            @slot('price') Ksh. 46,782  @endslot
        ...
        @component('common-components.dashboard-widget')
            ...
            @slot('class') bg-warning  @endslot
            @slot('title') Cars  @endslot
            @slot('price') 15 @endslot
        ...
        @component('common-components.dashboard-widget')
            @slot('icons') mdi mdi-account-group float-right  @endslot
            @slot('class') bg-primary  @endslot
            @slot('title') Drivers @endslot
            @slot('price') 9  @endslot
            @slot('badgeClass') badge-info @endslot
            @slot('per') +89%  @endslot
        @endcomponent
            ...
            <div class="card widget-user">
                <div class="widget-user-desc p-4 text-center bg-primary position-relative">
                    ...
                    <p class="text-white mb-0">The European languages are members of the same family. Their separate
                        existence is a myth. For science, music, sport, etc, Europe the same vocabulary. The languages
                        only in their grammar.</p>
                </div>
                <div class="p-4">
